...
// Glyph55vw is a 5-pixel high glyph.
type Glyph55vw uint32
...
func (g Glyph55vw) draw(f *Face55vw, dot fixed.Point26_6) (
	dr image.Rectangle,
	mask image.Image,
	maskp image.Point,
...
func (g Glyph55vw) bounds(f *Face55vw) (
...
func (g Glyph55vw) advance() (advance fixed.Int26_6) {
	return fixed.I(g.width())
}

// width returns the width of the glyph.
func (g Glyph55vw) width() int {
	return image55vw(g).width() + 1
}
